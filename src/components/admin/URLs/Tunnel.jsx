...
const modal = new tunnel()

export const URLModal = ({ children }) => {
  let [show, setShow] = useState(true)
  return (
    <>
      {show && (
        <modal.In>
          <div className='fixed inset-0 z-10 overflow-y-auto bg-gray-400 bg-opacity-30'>
...
export const URLModalOut = () => <modal.Out></modal.Out>
